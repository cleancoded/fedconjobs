...
<style>  .my_iframe_class *{font-family: RangeMono-Regular !important; font-size: 20px !important; color: #000 !important;}  </style>
<script>
window.onload = function() {
    var oFrame = document.getElementById("company_description_ifr");
    oFrame.contentWindow.document.onclick = function() {
		jQuery("#company_description_ifr").addClass('my_iframe_class');
