...
<form class="job_search_form<?php if ( $is_flat ) : ?> job_search_form--flat<?php endif; ?>" action="<?php echo jobify_get_listing_page_permalink() ? jobify_get_listing_page_permalink() : get_post_type_archive_link( 'job_listing' ); ?>" method="GET">
	...
	<div class="search_jobs">
		...
		<div class="search_keywords">
			<div class="label_keywords"><h6>What</h6><span>job title, keywords, or company</span></div>
		...
		<div class="search_location">
			<div class="label_keywords"><h6>Where</h6><span>City, State, or Zipcode</span></div>
		...
		if ( apply_filters( 'job_manager_job_filters_show_submit_button', true ) ) : ?>
			<div class="search_submit">
				<input type="submit" value="<?php esc_attr_e( 'Search Jobs', 'jobify' ); ?>">
			</div>
		<?php endif;
